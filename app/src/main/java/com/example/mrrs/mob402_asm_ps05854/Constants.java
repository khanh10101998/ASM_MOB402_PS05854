...
public class Constants {
    ...
    public static String url_all_products =
            "http://192.168.1.6/learn-login-register/get_all_product.php";
    public static String url_create_products =
            "http://192.168.1.6/learn-login-register/create_product.php";
    public static String url_product_detail =
            "http://192.168.1.6/learn-login-register/get_product_detail.php";
    public static String url_update_product =
            "http://192.168.1.6/learn-login-register/update_product.php";
    public static String url_delete_product =
            "http://192.168.1.6 /learn-login-register/delete_product.php";
    // JSON Node names
